...
(function(){
    ...
    function uploadJSSDK(config) {
        ...
        var file = config.file,
            ...
            upload_url = "https://upload.media.aliyun.com/api/proxy/upload",
            blockInit = "https://upload.media.aliyun.com/api/proxy/blockInit",
            blockUpload = "https://upload.media.aliyun.com/api/proxy/blockUpload",
            blockComplete = "https://upload.media.aliyun.com/api/proxy/blockComplete",
